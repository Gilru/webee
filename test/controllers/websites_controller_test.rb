...
class WebsitesControllerTest < ActionController::TestCase
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post :create, website: { description: @website.description, name: @website.name, price: @website.price, url: @website.url }
    end
  ...
  test "should update website" do
    patch :update, id: @website, website: { description: @website.description, name: @website.name, price: @website.price, url: @website.url }
    assert_redirected_to website_path(assigns(:website))
  end
